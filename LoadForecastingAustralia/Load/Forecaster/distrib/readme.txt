...
-Forecaster_1_0.dll (output from mcc)
-Forecaster.bas (VBA module file created by mcc)
-Forecaster.xla (created when you import .bas file into Excel)
-MCRInstaller.exe
   -include when building component by selecting "include MCR" option 
    in deploytool
-This readme file

NOTE: deploytool will include Forecaster.bas by default. 
      Forecaster.xla can be optionally included.


3. Definitions

MCR - MATLAB Builder EX uses the MATLAB Compiler Runtime (MCR), 
...
run MCRInstaller.exe to install version 7.13 of MCR. For 
more information about the MCR, see the MATLAB Compiler documentation.
